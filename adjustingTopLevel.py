...
class AdjustingTopLevel(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.r_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
        self.g_label = Label(self, text="Зелений")
        ...
        self.opening_button = Button(self, text="Open", width=10, font="ariel 11 bold")
        self.closing_button = Button(self, text="Closed", width=10, font="ariel 11 bold")
        self.gradient_button = Button(self, text="Gradient", width=10, font="ariel 11 bold")
        self.topHat_button = Button(self, text="TopHat", width=10, font="ariel 11 bold")
        self.blackHat_button = Button(self, text="BlackHat", width=10, font="ariel 11 bold")
        ...
        self.preview_button = Button(self, text="Перегляд",width=7, font="ariel 8 bold")
        self.cancel_button = Button(self, text="Скасувати",width=7, font="ariel 8 bold")
        self.clear_button = Button(self, text="Очистити",width=7, font="ariel 8 bold")
